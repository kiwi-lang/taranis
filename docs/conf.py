#!/usr/bin/env python
"""
taranis documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "taranis"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)


import taranis.core  # noqa
...
project = "taranis"
_full_version = taranis.core.__version__
author = taranis.core.__author__
copyright = taranis.core.__copyright__
